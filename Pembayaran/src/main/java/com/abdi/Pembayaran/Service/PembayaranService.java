...
import com.abdi.Pembayaran.Service.vo.Produk;
    ...
    public Pembayaran getPembayaranById(Long id) {
     ...
     public List<ResponseTemplate> getPembayaranWithOrderkById(Long id){
        ...
        Pembayaran pembayaran = getPembayaranById(id);
         Order order = restTemplate.getForObject("http://localhost:9008/api/v1/order/" 
                + pembayaran.getOrder_Id(), Order.class);  
        Produk produk = restTemplate.getForObject("http://localhost:9005/api/v1/produk/"
